<form name="crud"  method="post" action="../../../modelo/model_empleado/registrar_empleado.php" id="nueva_unidad">
<div class="modal fade" id="Modal_Nuevo_Personal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
   <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="exampleModalLabel">Registrar Nuevo Empleado</h4>
      </div>
 ...
 <div class="form-group col-md-12">
            ...
            <input type="number" class="form-control" id="ci" name="ci"  minlength="5" maxlength="100" onpaste="return false" required>
  </div>
   <div class="form-group col-md-12">
  ...
  <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="fecha_ingreso" name="fecha_ingreso"  minlength="5" maxlength="100" onpaste="return false" required>
  </div>
