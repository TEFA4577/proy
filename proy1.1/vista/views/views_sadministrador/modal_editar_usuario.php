<form name="crud"  method="post" action="../../../modelo/model_administrador/editar_usuario.php" id="nueva_unidad">
<div class="modal fade" id="Modal_Editar_Usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
 ...
 <div class="form-group col-md-12">
  <input type="hidden" class="form-control" id="ci" name="ci"  minlength="5" maxlength="100" onpaste="return false" required>
  <input type="hidden" class="form-control" id="id_usuario" name="id_usuario" minlength="5" maxlength="100" onpaste="return false" required>
            <label for="codigo" class="control-label" >CI:</label>
            <input type="text" class="form-control" id="ci" name="ci"  minlength="5" maxlength="100" onpaste="return false" disabled="" required>
  </div>
