<form name="crud"  method="post" action="../../../modelo/model_administrador/registrar_usuario.php" id="nueva_unidad">
<div class="modal fade" id="Modal_Nuevo_Usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
 ...
 <div class="form-group col-md-12">
   ...
   <div class="form-group col-md-12">
     ...
     <div class="form-group col-md-12">
            ...
            <input type="number" class="form-control" id="password" name="password"  minlength="5" maxlength="100" onpaste="return false" required>
  </div>
 ...
 <div class="form-group col-md-12">
  ...
  <!--<div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="estado" name="estado"  minlength="5" maxlength="100" onpaste="return false" required>
  </div>-->
