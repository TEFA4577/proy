			...
			<div class="modal-body">
				...
				<input type="hidden" id="item-id">
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Nombre del Medicamento:</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9"> 
				      <input type="number" min="0.1" step="any" class="form-control" id="item-price" placeholder="Ingresa el precio del medicamento" required="">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Laboratorio:</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="grams" placeholder="Ingresa la unidad del medicamento" required="" autofocus="">
				    </div>
				  </div>
